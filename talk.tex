...
Predicates form a semimodule closed semiring:

Functions from monoids to semirings (e.g., languages) also form the \emph{monoid semring}.

Commutative if the monoid and semiring are.

What about decidable languages?
Types interfere.
\end{frame}
