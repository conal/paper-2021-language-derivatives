...
In the definition of {\AB P \AF ☆}, \AB{concat} flattens a list of lists into a single list, defined as a right fold:
...
\agda{ν𝒟}
In terms of languages, {\AF{𝒟} \AB{P} \AB{u}} comprises all strings \AB{v} such that {\AB{u} \AF ⊙ \AB{v} \AF ∈ \AB{P}}, i.e., the \AB{u}-suffixes of strings in \AB{P}.
...
For type \AB{A}, the type {\AF{Dec} \AB{A}} contains proof of \AB{A} or a proof of {\AF ¬ \AB{A}} (defined as usual to mean {\AB{A} \AS → \AD{⊥}}):\footnote{This simple \AF{Dec} definition been superceded by a more efficient but more complex version \stdlibCitep{Relation.Nullary}.}
\agda{Dec}
