...
\begin{itemize}
\item
  A collection of lemmas are stated (and proved) that capture the semantic essence of Brzozowski's syntactic technique of derivatives of regular expressions, in terms of functions over lists.
\item
