...
Likewise, a proof of {w \AF ∈ \AB{P} \AF ⋆ \AB{Q}} (language concatenation) includes the choice of strings \AB{u} and \AB{v}, a proof that {\AB{u} \AF ⊙ \AB{v} \AD ≡ \AB{w}}, and proofs that {\AB{u} \AF ∈ \AB{P}} and {\AB{v} \AF ∈ \AB{Q}}.
