...
\end{code}
Referring to the type and operations of \secref{Specifying Languages} and \figref{symbolic-api} via the module prefix ``{◬.}\hspace{0.05em}'' and ``{▣.}\hspace{0.05em}'' respectively, define \agda{wrapped-Lang}
