...
The result is shown in \figrefdef{symbolic-api}{Regular expressions (inductive)}{\api} along with a trivially defined semantic function {\AF{⟦\_⟧}} (mapping any representation of type {\AF{Lang} \AB P} to the corresponding type-level language \AB{P}) and a less trivial, computable function  {\AF{⟦\_⟧‽}} that converts a symbolic language representation to a computable parser.
