...
Programs on inductive types are often proved by induction, while programs on coinductive types are often proved by coinduction\out{ and specifically bisimulation}.
...
\agda{𝒟′}
\begin{samepage}
The potential work-sharing version exploits the close relationship between \AB{f} and {\AF{𝒟} \AB{f}}:
\agda{ʻ𝒟}
\end{samepage}
Equivalence follows from a simple inductive argument, thanks to lemmas \AF{ν∘𝒟} and \AF{𝒟foldl} of \secref{Decomposing Languages}:
\agda{𝒟′≡ʻ𝒟}
