...
Since {\AB{u} \AF ⊙ \AIC{[]} \AD ≡ \AB{u}}, it follows that\footnote{Agda variable names can contain most characters other than spaces and parentheses, e.g., ``\AB{ν∘𝒟}'' as declared here.
For functions \AB{f} and \AB{g}, {\AB{f} \AF{≗} \AB{g}} is extensional equality, i.e., {\AS ∀ \AB x \AS → \AB{f} \AB{x} \AD{≡} \AB{g} \AB{x}}.}
\agda{ν∘𝒟}
