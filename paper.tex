...
For example, each instance of the \ARe{Monoid} abstraction involves a single type \AB τ with a binary operation {\AB{\_∙\_} \AK : \AB τ \AK → \AB τ \AK → \AB τ} and identity value {\AB ε \AK : \AB τ}.
